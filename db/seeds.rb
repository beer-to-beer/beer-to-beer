...
Criterion.create(rating_id: r1.id, name: "Price",value: "3")
Criterion.create(rating_id: r1.id, name: "Taste",value: "6")
Criterion.create(rating_id: r1.id, name: "Headache",value: "7")
Criterion.create(rating_id: r2.id, name: "Price",value: "7")
Criterion.create(rating_id: r2.id, name: "Taste",value: "6")
Criterion.create(rating_id: r2.id, name: "Headache",value: "7")
Criterion.create(rating_id: r3.id, name: "Price",value: "8")
Criterion.create(rating_id: r3.id, name: "Taste",value: "6")
Criterion.create(rating_id: r3.id, name: "Headache",value: "7")
Criterion.create(rating_id: r4.id, name: "Price",value: "9")
Criterion.create(rating_id: r4.id, name: "Taste",value: "6")
Criterion.create(rating_id: r4.id, name: "Headache",value: "7")
Criterion.create(rating_id: r5.id, name: "Price",value: "10")
Criterion.create(rating_id: r5.id, name: "Taste",value: "6")
Criterion.create(rating_id: r5.id, name: "Headache",value: "1")
Criterion.create(rating_id: r6.id, name: "Price",value: "5")
Criterion.create(rating_id: r6.id, name: "Taste",value: "2")
Criterion.create(rating_id: r6.id, name: "Headache",value: "3")