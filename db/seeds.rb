...
Event.create(title: "Test1", sdate: Date.current, club_id: cl1.id)
Event.create(title: "Test2", sdate: Date.current, club_id: cl1.id)
Event.create(title: "Test3", sdate: Date.current, club_id: cl.id)
Event.create(title: "Test4", sdate: Date.current, club_id: cl.id)
