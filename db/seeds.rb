...
r4 = Rating.create(beer_id: b1.id, user_id:thorsten.id, comment:"gut gut gut" )
r5 = Rating.create(beer_id: b2.id, user_id:thorsten.id, comment:"gut. dieser text muss lang werden" )
r6 = Rating.create(beer_id: b3.id, user_id:thorsten.id, comment:"gut gut gut" )
