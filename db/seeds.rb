...
Event.create!(title: "Test1", sdate: Date.current, club_id: cl1.id, imageURL: File.new("ace/app/assets/img/ace/uploads/event/image1.jpg", :encoding => "UTF-8"))
Event.create!(title: "Test2", sdate: Date.current, club_id: cl1.id, imageURL: File.new("ace/app/assets/img/ace/uploads/event/image2.jpg", :encoding => "UTF-8"))
Event.create!(title: "Test3", sdate: Date.current, club_id: cl.id, imageURL: File.new("ace/app/assets/img/ace/uploads/event/image3.jpg", :encoding => "UTF-8"))
Event.create!(title: "Test4", sdate: Date.current, club_id: cl.id, imageURL: File.new("ace/app/assets/img/ace/uploads/event/image4.jpg", :encoding => "UTF-8"))
