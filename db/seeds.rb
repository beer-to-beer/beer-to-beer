...
Event.create(title: "Test2", sdate: Date.current, club_id: cl1.id, imageURL: File.new("public/uploads/event/image-image.jpg", :encoding => "UTF-8"))
Event.create(title: "Test3", sdate: Date.current, club_id: cl.id, imageURL: File.new("public/uploads/event/image-image-image.jpg", :encoding => "UTF-8"))
Event.create(title: "Test4", sdate: Date.current, club_id: cl.id, imageURL: File.new("public/uploads/event/image-image-image-image.jpg", :encoding => "UTF-8"))
