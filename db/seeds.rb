...
Event.create(title: "Test1", sdate: Date.current, club_id: cl1.id, imageURL: open("https://s3.amazonaws.com/media.workhub.com/uploads/workhub-rails-grils-berlin-december-2.png"))
Event.create(title: "Test2", sdate: Date.current, club_id: cl1.id, imageURL: open("https://s3.amazonaws.com/media.workhub.com/uploads/workhub-rails-grils-berlin-december-2.png"))
Event.create(title: "Test3", sdate: Date.current, club_id: cl.id, imageURL: open("https://s3.amazonaws.com/media.workhub.com/uploads/workhub-rails-grils-berlin-december-2.png"))
Event.create(title: "Test4", sdate: Date.current, club_id: cl.id, imageURL: open("https://s3.amazonaws.com/media.workhub.com/uploads/workhub-rails-grils-berlin-december-2.png"))
