...
Event.create(title: "Test1", sdate: Date.current, club_id: cl1.id, imageURL: File.open("./public/uploads/event/image1.jpg"))
Event.create(title: "Test2", sdate: Date.current, club_id: cl1.id, imageURL: File.open("./public/uploads/event/image2.jpg"))
Event.create(title: "Test3", sdate: Date.current, club_id: cl.id, imageURL: File.open("./public/uploads/event/image3.jpg"))
Event.create(title: "Test4", sdate: Date.current, club_id: cl.id, imageURL: File.open("./public/uploads/event/image4.jpg"))
